...
const moduleKeys = ["dashboard", "students", "academics", "timetable", "attendance", "fees", "examinations", "homework", "hr", "documents", "transport", "hostel", "library", "inventory", "onlineExam", "questionBank", "reports"];
